...
public class Pesan1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                data.getNim(nimsiswa.getText().toString().trim());
                data.setNama(namasiswa.getText().toString().trim());
                refrence.push().setValue(data);
                Toast.makeText(Pesan1.this, "Data Tersimpan", Toast.LENGTH_LONG).show();
            }
        });
        ...
        btnView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Pesan1.this, Tampil_SemuaData.class);
